...
public class VierGewinnt
{
	...
	private int insertToken( int column, Token tok )
	{
		...
		if(!isLegalToken(column, tok)) printErrAndExit();
	...
	/**
	 * Checks if the move represented by column and token is legal
	 * @param column
	 * @param tok
	 * @return
	 */
	private boolean isLegalToken( int column, Token tok) {
